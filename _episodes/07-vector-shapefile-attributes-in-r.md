...
<img src="../fig/rmd-07-plot-subset-shapefile-1.png" title="plot of chunk plot-subset-shapefile" alt="plot of chunk plot-subset-shapefile" width="612" style="display: block; margin: auto;" />
...
<img src="../fig/rmd-07-plot-subset-shapefile-unique-colors-1.png" title="plot of chunk plot-subset-shapefile-unique-colors" alt="plot of chunk plot-subset-shapefile-unique-colors" width="612" style="display: block; margin: auto;" />
...
> > {: .language-r}
> > 
> > <img src="../fig/rmd-07-harv-boardwalk-map-1.png" title="plot of chunk harv-boardwalk-map" alt="plot of chunk harv-boardwalk-map" width="612" style="display: block; margin: auto;" />
> {: .solution}
{: .challenge}
...
> > {: .language-r}
> > 
> > <img src="../fig/rmd-07-harv-stone-wall-map-1.png" title="plot of chunk harv-stone-wall-map" alt="plot of chunk harv-stone-wall-map" width="612" style="display: block; margin: auto;" />
> {: .solution}
{: .challenge}
...
<img src="../fig/rmd-07-harv-paths-map-1.png" title="plot of chunk harv-paths-map" alt="plot of chunk harv-paths-map" width="612" style="display: block; margin: auto;" />
...
<img src="../fig/rmd-07-harv-paths-map-wide-1.png" title="plot of chunk harv-paths-map-wide" alt="plot of chunk harv-paths-map-wide" width="612" style="display: block; margin: auto;" />
...
> > {: .language-r}
> > 
> > <img src="../fig/rmd-07-harv-path-line-types-1.png" title="plot of chunk harv-path-line-types" alt="plot of chunk harv-path-line-types" width="612" style="display: block; margin: auto;" />
> {: .solution}
{: .challenge}
...
<img src="../fig/rmd-07-add-legend-to-plot-1.png" title="plot of chunk add-legend-to-plot" alt="plot of chunk add-legend-to-plot" width="612" style="display: block; margin: auto;" />
...
<img src="../fig/rmd-07-modify-legend-plot-1.png" title="plot of chunk modify-legend-plot" alt="plot of chunk modify-legend-plot" width="612" style="display: block; margin: auto;" />
...
<img src="../fig/rmd-07-plot-different-colors-1.png" title="plot of chunk plot-different-colors" alt="plot of chunk plot-different-colors" width="612" style="display: block; margin: auto;" />
...
> > {: .language-r}
> > 
> > <img src="../fig/rmd-07-harv-paths-bike-horses-1.png" title="plot of chunk harv-paths-bike-horses" alt="plot of chunk harv-paths-bike-horses" width="612" style="display: block; margin: auto;" />
> {: .solution}
{: .challenge}
...
> > 
> > ~~~
> > Reading layer `US-State-Boundaries-Census-2014' from data source `/home/runner/work/r-raster-vector-geospatial/r-raster-vector-geospatial/_episodes_rmd/data/NEON-DS-Site-Layout-Files/US-Boundary-Layers/US-State-Boundaries-Census-2014.shp' using driver `ESRI Shapefile'
...
> > {: .language-r}
> > 
> > <img src="../fig/rmd-07-colored-state-boundaries-1.png" title="plot of chunk colored-state-boundaries" alt="plot of chunk colored-state-boundaries" width="612" style="display: block; margin: auto;" />
> {: .solution}
{: .challenge}
